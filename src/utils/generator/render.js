  ...
  'el-radio-group': {
    options(h, conf, key) {
      return conf.optionType === 'button'
        ? conf.options.map(item => h(resolveComponent('el-checkbox-button'), {
            label: item.value,
          }, () => item.label))
        : conf.options.map(item => h(resolveComponent('el-radio'), {
            label: item.value,
            border: conf.border,
          }, () => item.label))
    },
  ...
  'el-checkbox-group': {
    options(h, conf, key) {
      return conf.optionType === 'button'
        ...
        : conf.options.map(item => h(resolveComponent('el-checkbox'), {
            label: item.value,
            border: conf.border,
          }, () => item.label))
    },
